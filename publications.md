...
- [Beyond ood state actions: Supported cross-domain offline reinforcement learning](https://arxiv.org/abs/2306.12755)<br>Jinxin Liu, Ziqi Zhang, **Zhenyu Wei**, Yachen Kang, Sibo Gai, Donglin Wang*<br>Proceedings of the AAAI Conference on Artificial Intelligence (AAAI 2024).<br>

- [BVIP Guiding System with Adaptability to Individual Differences](https://ieeexplore.ieee.org/document/10670739)<br>Yibo Zhou, Dongfei Cui, Xiangming Dong, Zongkai Wu, **Zhenyu Wei**, Donglin Wang*<br>2024 IEEE International Conference on Real-time Computing and Robotics (RCAR 2024).
...
<!-- - [Broadband Metamaterial-Based Dual-Polarized Patch Antenna With High Isolation and Low Cross Polarization]() -->
